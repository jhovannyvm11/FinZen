...
export default function Header({
  ...
  const getNavItemClasses = (href: string) => {
    ...
    return isActive
      ? "bg-primary-50 text-primary-600 px-3 py-2 rounded-md text-sm font-semibold"
      : "text-foreground-500 hover:text-foreground hover:bg-default-100 px-3 py-2 rounded-md text-sm font-semibold transition-colors";
  };
  return (
        ...
        <div className="max-w-7xl mx-auto">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center space-x-2.5">
              ...
              <div className="w-8 h-8 relative">
                <div className="absolute inset-0 bg-blue-600 rounded-lg">
                  <svg
                    className="w-6 h-6 text-white absolute top-1.5 left-0.5"
                    viewBox="0 0 24 13"
                    fill="currentColor"
                  >
                    <path d="M0 6h24v1H0z" />
            ...
            <nav className="hidden md:flex items-center space-x-1">
              ...
              <Link href="/accounts" className={getNavItemClasses("/accounts")}>
                {t("navigation.accounts")}
              </Link>
              <Link href="/wallet" className={getNavItemClasses("/wallet")}>
                {t("navigation.wallet")}
              </Link>
            </nav>
