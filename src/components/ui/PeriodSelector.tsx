...
export default function PeriodSelector({
  ...
  const periods = [
    { key: "this-month", label: t("periods.thisMonth") },
    { key: "last-month", label: t("periods.lastMonth") },
    { key: "this-year", label: t("periods.thisYear") },
    { key: "last-12-months", label: t("periods.last12Months") },
  ];
  ...
  const selectedPeriodLabel =
    periods.find((p) => p.key === selectedPeriod)?.label || "This month";
